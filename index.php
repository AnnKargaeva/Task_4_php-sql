...
$experience = [
    ...
    'duties' => 'Night racing. Demolish furniture on your way.',
    ],
    
    [
    'post' => 'Animal trainer',
    'time' => 'Dec 2022 - Jan 2022',
    'duties' => 'Training mice to different teams',
    ],
    
    [
    'post' => 'A fighter with plants',
    'time' => ' Nov 2022 - Dec 2022',
    'duties' => 'Dropping pots of different volumes',
    ],
];
?>
<!DOCTYPE html>
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <?php for ($i = 0; $i < count($experience); $i++):?>
            <div class="w3-container">
               <h5 class="w3-opacity"><b><?= $experience[$i]['post']; ?></b></h5>
